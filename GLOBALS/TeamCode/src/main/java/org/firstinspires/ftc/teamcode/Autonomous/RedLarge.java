...
public class RedLarge extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory Forward = TrajectoryGenerator.generateTrajectory(Arrays.asList(
                        ...
                        new Pose2d(3.1, 0, Rotation2d.fromDegrees(0))),
                new TrajectoryConfig(0.5, 0.2));

        Trajectory Park = TrajectoryGenerator.generateTrajectory(Arrays.asList(
                        new Pose2d(3.1, 0, Rotation2d.fromDegrees(90)),
                        new Pose2d(3.1, 1.2, Rotation2d.fromDegrees(90))),
                new TrajectoryConfig(0.5, 0.2));
        ...
        SequentialCommandGroup testCommandGroup = new SequentialCommandGroup(
                ...
                new MoveDoubleArm(armo, -15,150), //To be determined
