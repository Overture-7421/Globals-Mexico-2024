...
public class MainSystem extends LinearOpMode {
  ...
  // -----------------------------------------------------------------------------------------
       ...
       driverDpadDOWN.whenPressed(new MoveSingleArm(singleArm, -56)); //

        Button driverDpadUP= driverOp.getGamepadButton(GamepadKeys.Button.DPAD_UP);
        driverDpadUP.whenPressed(new MoveSingleArm(singleArm, -10)); //OverTHEPLATFORM
        ...
        driverButtonX.whenPressed(new MoveClaw(claw, 0.7)); //OpenClaw
